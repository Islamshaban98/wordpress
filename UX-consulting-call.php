...
get_header()
?>
<?php $consulting_hero=get_field('consulting_hero') ?>
<?php $services_body =get_field('services_body')?>
<?php $grey_section =get_field('grey_section')?>
    <div class="section-9">
      <div class="container-9 w-container">
        <div class="div-block-42">
          <h1 class="heading-10"><?php echo $consulting_hero['heading'] ?></h1>
          <h1 class="heading-9">
        <?php echo $consulting_hero['parag'] ?>
          </h1>
          <a
            href="<?php echo $consulting_hero['inquire_link']?>"
            target="_blank"
            class="button-ghost-1 white w-button"
            ><?php echo $consulting_hero['inquire_txt']?></a
          >
        ...
        <div class="div-block-43">
          <div class="ux-call-card">
            <div class="div-block-11">
              <img
                src="https://uploads-ssl.webflow.com/5d2d902bb78ea8d297844cef/5da66bd2c102b9e807316a47_Icon_call.svg"
                alt=""
                class="image-15"
              />
            </div>
            <div class="div-block-13">
              <h1 class="heading-12"><?php echo $consulting_hero['img_heading'] ?></h1>
            </div>
            <div class="div-block-12">
              <div class="text-block-4 services-header"><?php echo $consulting_hero['time'] ?></div>
              <div class="w-layout-grid grid-8 service-price">
                <div
                  id="w-node-c5e249b84994-1c59189c"
                  class="text-block-3 white"
                >
                  <?php echo $consulting_hero['cost'] ?>
                </div>
                <div id="w-node-c5e249b84996-1c59189c" class="currency">
                <?php echo $consulting_hero['currency'] ?>
                </div>
              </div>
            </div>
          </div>
          <div class="benefits-detail-page">
            <div class="div-block-51">
              <img
                src="<?php echo $consulting_hero['icon1'] ?>"
                alt=""
                class="image-11"
              />
              <div class="text white"><?php echo $consulting_hero['parag1'] ?></div>
            </div>
            <div class="div-block-53">
              <img
                src="<?php echo $consulting_hero['icon2'] ?>"
                alt=""
                class="image-11"
              />
              <div class="text-block-2 white"><?php echo $consulting_hero["parag2"]?></div>
            </div>
            <div class="div-block-52">
              <img
                src="<?php echo $consulting_hero['icon3'] ?>"
                alt=""
                class="image-11"
              />
              <div class="text-block-2 white"><?php echo $consulting_hero['parag3'] ?></div>
            </div>
          </div>
          <a
    ...
    <div class="section-26">
      ...
      <h1 class="heading-15">
        ...
        <a
          id="w-node-42188ec9192c-1c59189c"
